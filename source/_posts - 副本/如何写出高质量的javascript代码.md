...
> <pre lang="javascript">var month = "06",
>     year = "09";
...
其他的可以把字符串转为数字的方法有：
> <pre lang="javascript"> +"08" // result is 8
> Number("08") // 8</pre>
...
> <pre lang="javascript">function outer(a, b) {
>     var c = 1,
>         d = 2,
>         inner;
>     if (a &gt; b) {
...
> <pre lang="javascript">// bad practice
